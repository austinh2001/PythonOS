...
while not closed:
    ...
    for event in pygame.event.get():
        ...
        remainOpenInfo = (remainOpen, xStill, yStill, count)
        remainOpen = standingCheckClose('leftButton', 'rightButton', backgroundImg, 'SearchBox.jpg', leftButton, rightButton, remainOpenInfo)[0]
        xStill = standingCheckClose('leftButton', 'rightButton', backgroundImg, 'SearchBox.jpg', leftButton, rightButton, remainOpenInfo)[1]
        yStill = standingCheckClose('leftButton', 'rightButton', backgroundImg, 'SearchBox.jpg', leftButton, rightButton, remainOpenInfo)[2]
        count = standingCheckClose('leftButton', 'rightButton', backgroundImg, 'SearchBox.jpg', leftButton, rightButton, remainOpenInfo)[3]
        print("RemainOpen: " + str(remainOpen))
        standingCheckClose('leftButton', 'rightButton', backgroundImg, 'SearchBox.jpg', leftButton, rightButton, remainOpenInfo)
